...
public class OrderManagerView extends javax.swing.JFrame {
    ...
    /**
     * Creates new form restauranteUI
     *
     * @param controller
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderManagerView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrderManagerView().setVisible(true);
            }
        });
    }
